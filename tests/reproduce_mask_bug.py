...
def test_mask_bug():
	...
	Workflow:
		1. Create TransformerBackbone with specific config.
		2. Create input and padding mask.
		3. Run forward pass.
		4. Catch exception and verify it is the expected 4D tensor error (if bug exists).
