...
def test_model_forward_pass():
    ...
    Workflow:
        ...
        2. Instantiate MultiModalCreature.
        3. Create synthetic inputs for all modalities.
        4. Run forward pass.
        5. Verify output keys and types.
...
def test_model_loss_computation():
    ...
    Workflow:
        1. Setup minimal config.
        2. Instantiate model.
        3. Create fake outputs and targets.
        4. Call compute_loss.
        5. Verify loss is scalar and not NaN.
