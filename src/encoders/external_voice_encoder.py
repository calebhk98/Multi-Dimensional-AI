"""
External voice encoder - processes speech heard from others.
"""
...
class ExternalVoiceEncoder(nn.Module):
	"""
	Encoder for external voice (speech from other entities).
	
	Similar to internal voice encoder but with separate embeddings
	to distinguish between creature's thoughts and heard speech.
	"""
	...
	def __init__(
		...
		Function: __init__
		==============================================================================
		Purpose:  Initializes the ExternalVoiceEncoder module. Sets up embeddings for
		          vocabulary tokens, positions, and modality, along with normalization
		          and dropout layers.

		Parameters:
		    - vocab_size: int
		        Size of the vocabulary (default: 50257 for GPT-2/RoBERTa style).
		    - embedding_dim: int
		...
		Usage:
		    model = ExternalVoiceEncoder(vocab_size=50257, embedding_dim=512)
		==============================================================================
		"""
		super().__init__()
		...
		# Token embedding layer (separate from internal voice)
		...
		# Modality embedding (distinguishes external from internal voice)
	...
	def forward(
		...
		Function: forward
		==============================================================================
		Purpose:  Processes input token IDs into embeddings, adding positional and
